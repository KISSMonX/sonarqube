...
public class RemoveAction implements FavoritesWsAction {
  ...
  private Consumer<RemoveRequest> removeFavorite() {
    return request -> {
  ...
  private static Function<Request, RemoveRequest> toWsRequest() {
    return request -> new RemoveRequest(request.mandatoryParam(PARAM_COMPONENT));
  }
}
