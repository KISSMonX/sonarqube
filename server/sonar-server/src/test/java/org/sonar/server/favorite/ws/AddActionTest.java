...
public class AddActionTest {
  ...
  public void add_a_project() {
    ...
    assertThat(favorite.getResourceId()).isEqualTo(project.getId());
    assertThat(favorite.getUserId()).isEqualTo(USER_ID);
    assertThat(favorite.getKey()).isEqualTo("favourite");
  }
  ...
  public void add_a_file() {
    ...
    assertThat(favorites).hasSize(1);
    PropertyDto favorite = favorites.get(0);
    assertThat(favorite.getResourceId()).isEqualTo(file.getId());
    assertThat(favorite.getUserId()).isEqualTo(USER_ID);
    assertThat(favorite.getKey()).isEqualTo("favourite");
  }
